...
const { uploadNews, getAllPosts, getCombinedFeed, voteNews, deletePost } = require('../controllers/NewsController');
...
// Delete routes
router.delete('/post/:postId', authenticateAnyUser, deletePost);
router.delete('/community-comment/:commentId', authenticateAnyUser, deleteCommunityComment);
router.delete('/expert-comment/:commentId', authenticateAnyUser, deleteExpertComment);
