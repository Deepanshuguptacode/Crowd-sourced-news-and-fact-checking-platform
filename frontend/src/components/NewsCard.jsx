...
const NewsCard = ({ postId, title, content, factStatus, upvotes: initialUpvotes, downvotes: initialDownvotes, comments: initialComments, imageUrl, link:initiallink, aiReview,
  confidence }) => {
