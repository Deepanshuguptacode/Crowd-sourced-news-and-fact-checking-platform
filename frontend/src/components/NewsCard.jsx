      ...
      <div className="px-6 py-4 bg-gray-50/50 dark:bg-gray-800/50 border-t border-gray-200/50 dark:border-gray-700/50">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <div className="flex items-center space-x-2" data-tour={isFirst ? "home-voting-buttons" : undefined}>
              ...
              >
                ...
                <span data-tour={isFirst ? "home-upvote-count" : undefined} className="font-medium">{upvotes}</span>
              </button>
              ...
              >
                ...
                <span data-tour={isFirst ? "home-downvote-count" : undefined} className="font-medium">{downvotes}</span>
              </button>
            </div>
          </div>
          ...
          >
            ...
            <span data-tour={isFirst ? "home-comments-count" : undefined} className="font-medium">{comments.length} Comments</span>
          </button>
        </div>
      </div>
