...
export const buildDebateSteps = (analysis) => [
  ...
  },
  {
    ...
    stanceToSelect: analysis.multiGroupStance || 'for',
    autoType: {
  ...
  },
  {
    ...
    target: '[data-tour="debate-room-comment-input"]',
    stanceToSelect: analysis.singleGroupStance || 'for',
    autoType: {
      selector: '[data-tour="debate-room-comment-input"] textarea',
  ...
  },
  {
    ...
    target: '[data-tour="debate-room-comment-input"]',
    stanceToSelect: analysis.counterGroupStance || 'against',
    autoType: {
      selector: '[data-tour="debate-room-comment-input"] textarea',
  ...
  },
  {
    ...
    autoType: {
      selector: '[data-tour="debate-room-comment-input"] textarea',
      text: analysis.offTopicCommentText || DEBATE_MOCK.offTopic,
    },
    highlightSendBtn: true,
    waitForClick: 'send',
  },
