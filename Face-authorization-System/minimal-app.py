#!/usr/bin/env python3
"""
Minimal Face Authorization System API
Uses only essential imports to avoid loading issues
"""
...
# Try to import InsightFace with error handling
try:
...
if INSIGHTFACE_AVAILABLE:
    try:
        ...
        print(f"❌ Face analysis model failed to load: {e}")
        INSIGHTFACE_AVAILABLE = False
...
if __name__ == '__main__':
    ...
    print(f"📊 Face Model Loaded: {face_app is not None}")
